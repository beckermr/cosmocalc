...
CCALCHEADERS = cosmocalc.h cosmocalc_assert.h flrw_distances.h w0wacosmo.h eh98_transfunct.h linpowspec.h
CCALCSOURCES = flrw_distances.cpp w0wacosmo.cpp eh98_transfunct.cpp linpowspec.cpp
