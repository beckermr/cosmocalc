...
double HaloFitPowerSpectrum::operator()(double k, double a)
{
  ...
  Rsigma = gsl_spline_eval(nonlinear_powspec_spline[0],
			   a,nonlinear_powspec_acc[0]); //get_nonlinear_gaussnorm_scale(a);
  sigma2 = gsl_spline_eval(nonlinear_powspec_spline[1],
			   Rsigma,nonlinear_powspec_acc[1]); //gaussiannorm_linear_powspec_exact(Rsigma);
  dsigma2dR = gsl_spline_eval_deriv(nonlinear_powspec_spline[1],
				    Rsigma,nonlinear_powspec_acc[1]); //onederiv_gaussiannorm_linear_powspec_exact(Rsigma);
  d2sigma2d2R = gsl_spline_eval_deriv2(nonlinear_powspec_spline[1],
				       Rsigma,nonlinear_powspec_acc[1]); //twoderiv_gaussiannorm_linear_powspec_exact(Rsigma);
